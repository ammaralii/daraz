...
class OrderDeliveryResourceIT {
    ...
    private static final String DEFAULT_SHIPPING_STATUS = "AAAAAAAAA";
    private static final String UPDATED_SHIPPING_STATUS = "BBBBBBBBB";
    ...
    @Test
    @Transactional
    void getAllOrderDeliveriesByShippingStatusContainsSomething() throws Exception {
        // Initialize the database
        orderDeliveryRepository.saveAndFlush(orderDelivery);

        // Get all the orderDeliveryList where shippingStatus contains DEFAULT_SHIPPING_STATUS
        defaultOrderDeliveryShouldBeFound("shippingStatus.contains=" + DEFAULT_SHIPPING_STATUS);

        // Get all the orderDeliveryList where shippingStatus contains UPDATED_SHIPPING_STATUS
        defaultOrderDeliveryShouldNotBeFound("shippingStatus.contains=" + UPDATED_SHIPPING_STATUS);
    }

    @Test
    @Transactional
    void getAllOrderDeliveriesByShippingStatusNotContainsSomething() throws Exception {
        // Initialize the database
        orderDeliveryRepository.saveAndFlush(orderDelivery);

        // Get all the orderDeliveryList where shippingStatus does not contain DEFAULT_SHIPPING_STATUS
        defaultOrderDeliveryShouldNotBeFound("shippingStatus.doesNotContain=" + DEFAULT_SHIPPING_STATUS);

        // Get all the orderDeliveryList where shippingStatus does not contain UPDATED_SHIPPING_STATUS
        defaultOrderDeliveryShouldBeFound("shippingStatus.doesNotContain=" + UPDATED_SHIPPING_STATUS);
    }
