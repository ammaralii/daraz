...
class ShippingDetailsResourceIT {
    ...
    private static final String DEFAULT_SHIPPING_METHOD = "AAAA";
    private static final String UPDATED_SHIPPING_METHOD = "BBBB";
    ...
    @Test
    @Transactional
    void getAllShippingDetailsByShippingMethodContainsSomething() throws Exception {
        // Initialize the database
        shippingDetailsRepository.saveAndFlush(shippingDetails);

        // Get all the shippingDetailsList where shippingMethod contains DEFAULT_SHIPPING_METHOD
        defaultShippingDetailsShouldBeFound("shippingMethod.contains=" + DEFAULT_SHIPPING_METHOD);

        // Get all the shippingDetailsList where shippingMethod contains UPDATED_SHIPPING_METHOD
        defaultShippingDetailsShouldNotBeFound("shippingMethod.contains=" + UPDATED_SHIPPING_METHOD);
    }

    @Test
    @Transactional
    void getAllShippingDetailsByShippingMethodNotContainsSomething() throws Exception {
        // Initialize the database
        shippingDetailsRepository.saveAndFlush(shippingDetails);

        // Get all the shippingDetailsList where shippingMethod does not contain DEFAULT_SHIPPING_METHOD
        defaultShippingDetailsShouldNotBeFound("shippingMethod.doesNotContain=" + DEFAULT_SHIPPING_METHOD);

        // Get all the shippingDetailsList where shippingMethod does not contain UPDATED_SHIPPING_METHOD
        defaultShippingDetailsShouldBeFound("shippingMethod.doesNotContain=" + UPDATED_SHIPPING_METHOD);
    }
