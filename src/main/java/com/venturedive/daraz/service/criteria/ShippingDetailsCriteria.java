package com.venturedive.daraz.service.criteria;
...
/**
 * Criteria class for the {@link com.venturedive.daraz.domain.ShippingDetails} entity. This class is used
 * in {@link com.venturedive.daraz.web.rest.ShippingDetailsResource} to receive all the possible filtering options from
...
public class ShippingDetailsCriteria implements Serializable, Criteria {
    ...
    public StringFilter shippingMethod() {
        if (shippingMethod == null) {
            shippingMethod = new StringFilter();
        }
        return shippingMethod;
    }
