...
import { getEntity, deleteEntity } from './products.reducer';
...
export const ProductsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="darazApp.products.delete.question">Are you sure you want to delete Products {productsEntity.id}?</ModalBody>
      <ModalFooter>
